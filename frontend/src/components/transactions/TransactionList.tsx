...
interface Props {
  /** Incremented by parent when a new transaction is added, triggers refresh */
  refreshKey?: number;
}
    ...
    <div className="transaction-list-wrapper">
      ...
      {loading ? (
        ...
        <div className="transaction-table">
          ...
          {transactions.map((t) => {
            const color =
              CATEGORY_COLORS[t.category ?? "uncategorized"] ??
            ...
            return (
              <div key={t.id} className="transaction-row">
                ...
                <span className="tx-desc" title={t.description}>
                  {t.description}
                </span>
                ...
                <span
                  className={`tx-amount align-right ${
